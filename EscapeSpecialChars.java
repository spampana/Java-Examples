...
*/
public  final class EscapeSpecialChars {
 ...
 <P>An ampersand character may appear in the query string of a URL.
  ...
  extra work.
 */
 public  String forHrefAmpersand(String aURL){
   return aURL.replace("&", "&amp;");
 }
  ...
  */
  public  String forURL(String aURLFragment){
    String result = null;
    try {
 ...
 */
 public   String forXML(String aText){
   ...
   final StringCharacterIterator iterator = new StringCharacterIterator(aText);
   char character =  iterator.current();
   while (character != CharacterIterator.DONE ){ //%,#,- _
     if (character == '<') {
       result.append("&lt;");
     }
     else if (character == '>') {
 ...
 */
 public  String toDisableTags(String aText){
   final StringBuilder result = new StringBuilder();
   final StringCharacterIterator iterator = new StringCharacterIterator(aText);
   char character =  iterator.current();
   while (character != CharacterIterator.DONE ){
 ...
 */  
 public  String forScriptTagsOnly(String aText){
   String result = null;
